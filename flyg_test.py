...
parser.add_argument('--patch_xy', type=int, default=100, help="the width and height of image sequence")
parser.add_argument('--patch_t', type=int, default=100, help="the slices of image sequence")
